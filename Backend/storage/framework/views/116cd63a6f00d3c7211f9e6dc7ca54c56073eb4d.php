<div class="form-group <?php echo !$errors->has($label) ?: 'has-error'; ?>">
    ...
    <label for="<?php echo e($id, false); ?>" class="col-sm-2 control-label">Coordinates</label>

    <div class="<?php echo e($viewClass['field'], false); ?>">

          <div class="col-sm-12 input-group" style="margin-bottom: 15px">
              <input id="coordinates" class="form-control" type="text" name="coordinates" value="<?php echo e($value, false); ?>"/>
          </div>
...
<?php /**PATH /www/wwwroot/dbf.dbestech.com/resources/views/admin/zonecontent.blade.php ENDPATH**/ ?>