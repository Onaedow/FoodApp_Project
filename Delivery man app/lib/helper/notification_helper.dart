    ...
    if(!GetPlatform.isIOS) {
      ...
      if(data) {
        ...
        if(GetPlatform.isAndroid) {
          _image = '${AppConstants.BASE_URL}/storage/app/public/notification/${message.notification!.android!.imageUrl!}';
        }else if(GetPlatform.isIOS) {
          _image ='${AppConstants.BASE_URL}/storage/app/public/notification/${message.notification!.apple!.imageUrl}';
        }
      }
